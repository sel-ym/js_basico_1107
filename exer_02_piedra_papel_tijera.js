...
// while (llueve) {
//     for (let i = 1; i <= 5 ; i++) {
//         console.log("Hoy es día ${i} y está lloviendo");
//         if (i == 5) {
...
// } while (nombre_jugador.trim == " " || nombre_jugador == null) 
//     {nombre_jugador = prompt(mensaje_inicial)

// {
//     for (let i = 1; i <= nombre_jugador.length; i++)
// }

alert(`...Anónimos NO admitidos`)
}
